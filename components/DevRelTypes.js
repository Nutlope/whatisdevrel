...
export default function DevRelTypes() {
  return (
    <>
      ...
      <p className="mt-4">
        While I'll be discussing 3 types of DevRels, many developer advocates do
        a mix of these. It's important to remember that these aren't always
        individual jobs.{" "}
      </p>
      <ul className="my-10 space-y-4 sm:grid sm:grid-cols-1 sm:gap-6 sm:space-y-0 lg:grid-cols-3 lg:gap-8">
        <li className="rounded-lg bg-gray-800 py-10 px-6 text-center xl:px-10">
      ...
      <p>
        Community-focused DevRel centers around growing and managing a community
        of developers. This is usually a Slack or Discord community that's
        focused on a company's product or an open source technology. Managing a
        community consists of answering questions, designing the community in an
        inclusive way, and making sure members are getting value through
        activities like livestreams and other events.
      </p>
      ...
      <p>
        ...
        making videos, teaching workshops, recording podcasts, tweeting and
        more. Content can be an SEO play focused on the long term or be a short
        term promotion like new feature launches.
      </p>
      ...
      <p className="">
        ...
        they're using it, then making improvements to the documentation and
        creating guides based on their answers. This can also extend to the
