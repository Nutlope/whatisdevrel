  ...
  return (
    <>
      <div className="mx-auto max-w-4xl">
        ...
        <div className="mt-4 w-full text-center text-5xl font-bold tracking-tight sm:text-6xl">
          The 3 types of DevRels
        </div>
        <p className="mt-4">
          While I'll be discussing 3 types of DevRels, many developer advocates
          do <span className="italic">a mix of these.</span> It's important to
          remember that these don't always map to individual jobs.{" "}
        </p>
      </div>
