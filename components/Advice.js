        ...
        <div className="mx-auto max-w-4xl text-left">
          ...
          <ul className="ml-4 list-disc space-y-3">
            <li>
              ...
              possible so they can determine whether or not your product is
              right for them.
            </li>
            <li>
            ...
            <li>
              ...
              comprehensive, high-quality resources (e.g. great API
            ...
            <li>
              ...
              developer and then imagine you are writing to that individual
              person each time. This quickly eliminates anything sales-y and
              helps produce genuinely useful content.
            </li>
            <li>
              <span className="font-bold">Think beyond the 9-to-5.</span> Many
              developers are developers in and out of work, with side projects
              on a wide range of topics (from hacking their dishwasher to
              building a marketplace or a game).
            </li>
            <li>
